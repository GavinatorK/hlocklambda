...
def lambda_handler(event, context):
    ...
    try:
        callSMBatchInf(key, bucket, outBucket="honorlock-sm-inf", prefix="inf-xgb-")
...
def callSMBatchInf(key, bucket, outBucket="honorlock-sm-inf", prefix="inf-xgb"):
    ...
    transform_job_name = "automl-honorlock-transform-" + timestamp_suffix
