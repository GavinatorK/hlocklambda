...
def addHeader(landingBucket, inputfileName, infBucket, infFileName):
    ...
    with open(local_path_landing, 'r') as f, open(local_path_inf, 'r') as inf, open("/tmp/180daysprediction.csv",
                                                                                    'w') as out:
        header = f.readline()
    ...
    upload_s3_obj(infBucket, "quicksight/honorlock-180day-testcount.csv", "/tmp/180daysprediction.csv")
...
def lambda_handler(event, context):
    ...
    landingBucket = 'honorlock-landing'
    ...
    # add header and upload to quicksight folder
